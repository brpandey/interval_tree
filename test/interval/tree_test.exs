defmodule Interval.Tree.Test do
  ...
  describe "interval insertions" do
    ...
    test "multiple insertions, right skew" do
      ...
      assert "#IntervalTree<{4, {26..76, 76, {23..34, 34, nil, nil}, {32..40, 40, nil, {34..36, 36, nil, nil}}}}>" =
               "#{inspect(tree)}"
    end
    ...
    test "multiple insertions, left skew" do
      ...
      # after avl implemented
      assert "#IntervalTree<{4, {32..40, 76, {26..76, 76, {23..34, 34, nil, nil}, nil}, {34..36, 36, nil, nil}}}>" =
               "#{inspect(tree)}"
    end
    ...
    test "multiple insertions, right-left skew" do
      ...
      assert "#IntervalTree<{6, {28..35, 76, {26..76, 76, {23..34, 34, nil, nil}, {26..55, 55, nil, nil}}, {32..40, 40, nil, {34..36, 36, nil, nil}}}}>" =
               "#{inspect(tree)}"
    end
    ...
    test "multiple insertions, left-right skew" do
      ...
      assert "#IntervalTree<{6, {26..76, 76, {26..55, 55, {23..34, 34, nil, nil}, nil}, {32..40, 40, {28..35, 35, nil, nil}, {34..36, 36, nil, nil}}}}>" ==
               "#{inspect(tree)}"
    end
    ...
    test "multiple insertions, checking each step" do
      ...
      assert "#IntervalTree<{3, {15..23, 23, {8..9, 9, nil, nil}, {16..21, 21, nil, nil}}}>" =
               "#{inspect(tree)}"

      tree = Tree.insert(tree, value4)

      assert "#IntervalTree<{4, {15..23, 30, {8..9, 9, nil, nil}, {16..21, 30, nil, {25..30, 30, nil, nil}}}}>" =
               "#{inspect(tree)}"

      # we do a right-left rotate
      tree = Tree.insert(tree, value5)

      assert "#IntervalTree<{5, {15..23, 30, {8..9, 9, nil, nil}, {17..19, 30, {16..21, 21, nil, nil}, {25..30, 30, nil, nil}}}}>" =
               "#{inspect(tree)}"

      tree = Tree.insert(tree, value6)

      assert "#IntervalTree<{6, {15..23, 30, {8..9, 9, {5..8, 8, nil, nil}, nil}, {17..19, 30, {16..21, 21, nil, nil}, {25..30, 30, nil, nil}}}}>" =
               "#{inspect(tree)}"

      # we do a left-right rotate
      tree = Tree.insert(tree, value7)

      assert "#IntervalTree<{7, {15..23, 30, {6..10, 10, {5..8, 8, nil, nil}, {8..9, 9, nil, nil}}, {17..19, 30, {16..21, 21, nil, nil}, {25..30, 30, nil, nil}}}}>" =
               "#{inspect(tree)}"

      tree = Tree.insert(tree, value8)

      assert "#IntervalTree<{8, {15..23, 30, {6..10, 10, {5..8, 8, {0..3, 3, nil, nil}, nil}, {8..9, 9, nil, nil}}, {17..19, 30, {16..21, 21, nil, nil}, {25..30, 30, nil, nil}}}}>" =
               "#{inspect(tree)}"

      tree = Tree.insert(tree, value9)

      assert "#IntervalTree<{9, {15..23, 30, {6..10, 10, {5..8, 8, {0..3, 3, nil, nil}, nil}, {8..9, 9, nil, nil}}, {17..19, 30, {16..21, 21, nil, nil}, {25..30, 30, nil, {26..27, 27, nil, nil}}}}}>" =
               "#{inspect(tree)}"

      tree = Tree.insert(tree, value10)

      assert "#IntervalTree<{10, {15..23, 30, {6..10, 10, {5..8, 8, {0..3, 3, nil, nil}, nil}, {8..9, 9, nil, nil}}, {17..19, 30, {16..21, 21, nil, nil}, {25..30, 30, {19..20, 20, nil, nil}, {26..27, 27, nil, nil}}}}}>" =
               "#{inspect(tree)}"
    end
  end
